                ...
                if ($incart == 0) {
                    echo "
                        <div class='text-center d-flex flex-row mt-2'>
                            <a href='./apis/customer-daemon.php?subject=cart&query=add&pid=$pid&sid=$sid' class='btn btn-info mr-2 w-50'>ADD</a> 
                            <a href='./apis/customer-daemon.php?subject=cart&query=remove&pid=$pid&sid=$sid' class='btn btn-secondary w-50 disabled'>REMOVE</a>
                        </div>
                    ";
                } else {
                    echo "
                        <div class='d-flex flex-row mt-2'>  
                            ...
                            <a href='./apis/customer-daemon.php?subject=cart&query=remove&pid=$pid&sid=$sid' class='btn btn-secondary w-50'>REMOVE</a>
                        </div>
                    ";
                }
            }
